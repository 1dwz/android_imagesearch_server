...
class MJPEGStreamReader:
    ...
    def health_check(self) -> Dict:
        ...
        with self.lock:
            now = time.time()
            frame_age = now - self.frame_timestamp if self.frame_timestamp > 0 else 9999999.0
            ...
            return {
                ...
                "last_activity_seconds_ago": now - self.last_activity if self.last_activity > 0 else 9999999.0
            }
